...
public class MainActivity extends AppCompatActivity implements TasksAdapter.DeleteTaskListener {
    ...
    private void configureViewModel(){
        ViewModelFactory viewModelFactory = Injection.sViewModelFactory(this);
        this.mTaskViewModel = ViewModelProviders.of(this, viewModelFactory).get(TaskViewModel.class);
    }

    private void getProjects(){
        this.mTaskViewModel.getProjects().observe(this, this::updateProject);
    }

    private void updateProject(List<Project> projects){
        mProjectList = projects;
        adapter.updateProjects(mProjectList);
    }
    ...
    /**
     * Filter the list of tasks in the UI
     */
